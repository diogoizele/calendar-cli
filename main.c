...
int main(int argc, char **argv) {
  ...
  char day[3];
  char month[3];
  int date, year, first_day_of_jan, month_in_number,
      quantity_days_current_month, f_d_month;
  ...
  for (int i = 0; i < f_d_month; i++) printf("    ");
